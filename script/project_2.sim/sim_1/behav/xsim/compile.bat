...
REM
REM Generated by Vivado on Wed Dec 08 14:08:16 +0900 2021
...
call xvlog  --incr --relax -L uvm -L axi_vip_v1_1_8 -L processing_system7_vip_v1_0_10 -L xilinx_vip -prj testbench_vlog.prj -log xvlog.log
